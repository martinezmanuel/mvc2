	...
	<div class="card-body">
		...
		<form id="playerForm" action="/player/save" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="playerFormPseudo" id="playerFormPseudo" value="{$joueur->pseudo_user}">
				<label for="playerFormPseudo">Quel est le nom du joueur ?</label>
				<input type="text" class="form-control" name="playerFormNom" id="playerFormNom" value="{$joueur->nom_user}">
			</div>
			<p>
